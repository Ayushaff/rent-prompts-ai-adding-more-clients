...
import FileUpload from "../PrivateRapp/ImageUpload";
            ...
            <div className="flex gap-4 items-center mb-2">
              ...
              {variable.type === 'string' && (
                <div className="flex flex-col w-full mb-3">
                  ...
                  <Input
                    type="text"
                    value={variable.value || ''} // Ensure value is never undefined
                    placeholder={variable.placeholder || `Enter ${variable.displayName}`}
              ...
              {variable.type === 'number' && (
                <div className="flex flex-col w-full mb-3">
                  ...
                  <Input
                    type={variable.type}
                    value={variable.value || ''} // Ensure value is never undefined
                    placeholder={variable.placeholder || `Enter ${variable.type}`}
                    className="border rounded-lg"
                    onChange={(e) => onValueChange(variable, e.target.value)}
                  />
                </div>
              ...
              {variable.type === 'boolean' && (
                <div className="flex gap-3 items-center mb-3 w-full">
                  <Checkbox
                    ...
                    className="border rounded-lg"
                    onChange={() => onValueChange(variable, !variable.value)}
                  />
