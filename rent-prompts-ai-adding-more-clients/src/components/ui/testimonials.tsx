...
import useMasonry from "@/utilities/useMasonry";
import Image, { StaticImageData } from "next/image";
import TestimonialImg01 from "../../../public/DummyRapps.png";
import ClientImg01 from "../../../public/DummyRapps.png";
          ...
          >
            {testimonials.map((testimonial, index) => (
              <div key={index} className="">
                ...
                <p className="text-indigo-200/65 whitespace-normal break-words before:content-['“'] after:content-['”']">
                  {testimonial.content}
                  </p>
                </Testimonial>
              </div>
